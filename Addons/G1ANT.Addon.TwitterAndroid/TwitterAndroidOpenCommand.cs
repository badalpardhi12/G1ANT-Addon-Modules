...
{
    [Command(Name = "twitterandroid.open", Tooltip = "Opens Twitter app instance on a connected android device.")]
    public class TwitterAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("StartActivity");
        ...
        public TwitterAndroidOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
