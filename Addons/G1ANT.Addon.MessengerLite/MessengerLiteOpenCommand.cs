...
{
    [Command(Name = "messengerlite.open", Tooltip = "Opens Messenger Lite instance on a connected android device.")]
    public class MessengerLiteOpenCommand : Language.Command
    {
        private static AndroidDriver<AndroidElement> driver;
        public class Arguments : CommandArguments
        {
            [Argument(DefaultVariable = "AppActivity", Tooltip = "AppActivity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.facebook.mlite.coreui.view.MainActivity");

            [Argument(DefaultVariable = "AppPackage", Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.facebook.mlite");
        ...
        public MessengerLiteOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
