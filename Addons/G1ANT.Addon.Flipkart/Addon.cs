...
{
    [Addon(Name = "Flipkart", Tooltip = "Operations on Flipkart")]
    [Copyright(Author = "Badal", Copyright = "G1ANT Robot Ltd", Email = "pardhibadal19970@gmail.com", Website = "www.badalshares.com")]
    [License(Type = "LGPL", ResourceName = "License.txt")]
    //[CommandGroup(Name = "", Tooltip = "")]
    public class FlipkartAddon : G1ANT.Language.Addon
    {
