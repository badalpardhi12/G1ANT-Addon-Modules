...
{
    [Command(Name = "instagramandroid.open", Tooltip = "This command opens an instagram application instance in the connected android device.")]
    public class InstagramAndroidOpenCommand : Language.Command
    {
        ...
        public InstagramAndroidOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
