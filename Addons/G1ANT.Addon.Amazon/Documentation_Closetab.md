...
```G1ANT
amazon.close type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```
...
#Note: the commands require opening a browser with the amazon.open command first.

## Example

This script open chrome browser and close the 
