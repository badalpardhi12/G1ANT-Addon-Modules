...
{
    [Command(Name = "whatsapp.open", Tooltip = "Opens Whatsapp instance on a connected android device.")]
    public class WhatsappOpenCommand : Language.Command
    {
        private static AndroidDriver<AndroidElement> driver;
        public class Arguments : CommandArguments
        {
            [Argument(DefaultVariable = "AppActivity", Tooltip = "AppActivity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.whatsapp.HomeActivity");
        ...
        public WhatsappOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
